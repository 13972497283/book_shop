	...
	<div class="products" style="margin-top:-40px;background:#fbffc038">	 
		<div class="container">
			...
			<div style="text-align: center">
				...
				<ul class="pagination">
					<li ><a href="/index/goods.do?cid=${pageInfo.list.get(0).cid}&page=1">首页</a></li>
					...
					<c:if test="${pageInfo.pageNum!=1}">
						<li >
							<a href="/index/goods.do?cid=${pageInfo.list.get(0).cid}&page=${pageInfo.prePage}" aria-label="Previous">
								<span aria-hidden="true">&laquo;</span>
							</a>
						</li>
					</c:if>
					<c:forEach begin="${startEnd[0]}" end="${startEnd[1]}" var="i">
						<c:if test="${pageInfo.pageNum==i}">
							<li class="active"><a href="/index/goods.do?cid=${pageInfo.list.get(0).cid}&page=${i}">${i}</a></li>
						</c:if>
						<c:if test="${pageInfo.pageNum!=i}">
							<li ><a href="/index/goods.do?cid=${pageInfo.list.get(0).cid}&page=${i}">${i}</a></li>
						</c:if>
					</c:forEach>
					<c:if test="${pageInfo.pageNum==pageInfo.lastPage}">
						<li class="disabled">
							<a href="/index/goods.do?cid=${pageInfo.list.get(0).cid}&page=${pageInfo.nextPage}" aria-label="Next">
					...
					<li ><a href="/index/goods.do?cid=${pageInfo.list.get(0).cid}&page=${pageInfo.total}">尾页</a></li>
				</ul>
