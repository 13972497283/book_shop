...
<body>
	...
	<div style="text-align: center">
		<nav aria-label="Page navigation">
			<ul class="pagination">
				<li ><a href="/admin/goodList.do?page=1&searchName=${searchName}">首页</a></li>
				...
				<c:if test="${pageInfo.pageNum!=1}">
					<li >
						<a href="/admin/goodList.do?page=${pageInfo.prePage}&searchName=${searchName}" aria-label="Previous">
							<span aria-hidden="true">&laquo;</span>
						</a>
					</li>
				</c:if>
				<c:forEach begin="${startEnd[0]}" end="${startEnd[1]}" var="i">
					<c:if test="${pageInfo.pageNum==i}">
						<li class="active"><a href="/admin/goodList.do?page=${i}&searchName=${searchName}">${i}</a></li>
					</c:if>
					<c:if test="${pageInfo.pageNum!=i}">
						<li ><a href="/admin/goodList.do?page=${i}&searchName=${searchName}">${i}</a></li>
					</c:if>
				</c:forEach>
				<c:if test="${pageInfo.pageNum==pageInfo.lastPage}">
					<li class="disabled">
						<a href="/admin/goodList.do?page=${pageInfo.nextPage}&searchName=${searchName}" aria-label="Next">
				...
				<li ><a href="/admin/goodList.do?page=${pageInfo.total}&searchName=${searchName}">尾页</a></li>
			</ul>
